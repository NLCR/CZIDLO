...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template name="titleInfo">
        <czi:titleInfo>
            ...
            <xsl:call-template name="volumeTitle"/>
        </czi:titleInfo>
    </xsl:template>
    ...
    <xsl:template name="volumeTitle">
        <xsl:variable name="volumeTitle" select="//mods:mods/mods:titleInfo/mods:partNumber"/>
        <xsl:if test="$volumeTitle and $volumeTitle != ''">
            <czi:volumeTitle>
                <xsl:call-template name="cutString">
                    <xsl:with-param name="string" select="$volumeTitle"/>
                    <xsl:with-param name="maxLength" select="100"/>
                </xsl:call-template>
            </czi:volumeTitle>
        </xsl:if>
    ...
    <xsl:template name="issn">
        <xsl:variable name="issn" select="//mods:mods/mods:identifier[@type='issn']"/>
        <xsl:if test="$issn">
            <czi:isbn>
    ...
    <xsl:template name="otherId">
        <xsl:variable name="otherIdWithType"
                      select="//mods:mods/mods:identifier[@type and @type!='urnnbn' and @type!='issn' and @type!='ccnb']"/>
