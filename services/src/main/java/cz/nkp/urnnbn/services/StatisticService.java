...
public interface StatisticService extends BusinessService {
     ...
     *
     * @param includeActive      if URN:NBNs that are currently active should be included
     * @param includeDeactivated if URN:NBNs that are now deactivated should be included
