...
public interface DataImportService extends BusinessService {
     ...
     *
     * @param importData
     *            Data object containing intelectual entity and digital document records
     * @param login
     ...
     *             If registrar code in urn:nbn and registrar code from importData don't match
     * @throws UrnUsedException
     *             If this urn:nbn is allready being used
     * @throws UnknownRegistrarException
     *             if no such registrar with code obtained from importData object exists
     * @throws RegistarScopeIdentifierCollisionException
     *             if registrar scope identifier with same type and value as one of those present in importData already exists (for given registrar)
     * @throws UnknownArchiverException
     *             if no such archiver (with id obtained from importData) existes
    ...
    public UrnNbn registerDigitalDocument(DigDocRegistrationData importData, String login) throws AccessException, UnknownUserException,
            ...
            IncorrectPredecessorStatus, RegistarScopeIdentifierCollisionException;
     ...
     * @throws UnknownUserException
     *             if user identified by login doesn't exist
     * @throws AccessException
     *             if user doesn't have right to registrar that owns the digital library (identified by id from DigitalInstance)
     * @throws UnknownDigLibException
     *             if digital library identified by id obtained from DigitalInstance doesn't exist
     * @throws UnknownDigDocException
     *             if digital document (identified by id obtained from DigitalInstance) doesn't exist
     */
