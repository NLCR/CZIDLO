...
import cz.nkp.urnnbn.api.v5.json.JsonErrorBuilder;
import cz.nkp.urnnbn.xml.apiv5.builders.XmlErrorBuilder;
...
public class ApiV5Exception extends WebApplicationException {

    public ApiV5Exception(ResponseFormat format, Status status, String errorCode, String errorMessage) {
