...
import cz.nkp.urnnbn.api.v5.exceptions.UnknownRegistrarException;
import cz.nkp.urnnbn.api.v5.json.RegistrarBuilderJson;
import cz.nkp.urnnbn.api.v5.json.RegistrarsBuilderJson;
import cz.nkp.urnnbn.core.RegistrarCode;
import cz.nkp.urnnbn.core.dto.Registrar;
import cz.nkp.urnnbn.core.persistence.exceptions.DatabaseException;
import cz.nkp.urnnbn.xml.apiv5.builders.RegistrarBuilder;
import cz.nkp.urnnbn.xml.apiv5.builders.RegistrarsBuilder;
...
@Path("/registrars")
public class RegistrarsResource extends ApiV5Resource {
    ...
    private RegistrarsBuilder registrarBuilderXml(boolean addDigitalLibraries, boolean addCatalogs) throws DatabaseException {
        ...
        List<RegistrarBuilder> registrarBuilders = new ArrayList<>(registrars.size());
    ...
    private RegistrarsBuilderJson registrarBuilderJson(boolean addDigitalLibraries, boolean addCatalogs) throws DatabaseException {
        List<Registrar> registrars = dataAccessService().registrars();
        List<RegistrarBuilderJson> registrarBuilders = new ArrayList<>(registrars.size());
        for (Registrar registrar : registrars) {
