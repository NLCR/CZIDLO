...
import cz.nkp.urnnbn.xml.apiv6.unmarshallers.DigitalInstanceUnmarshaller;
...
public class DigitalInstancesResource extends ApiV6Resource {
    ...
    public Response addNewDigitalInstance(@Context HttpServletRequest req, String content) {
        ...
        try {
            ...
            Document requestXmlData = ApiModuleConfiguration.instanceOf().getDigInstImportDataValidatingLoaderV6().loadDocument(content);
