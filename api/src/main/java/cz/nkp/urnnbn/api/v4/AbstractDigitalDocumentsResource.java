...
public abstract class AbstractDigitalDocumentsResource extends V4Resource {
    ...
    protected String registerDigitalDocument(String content, String login, RegistrarCode registrarCode) throws ValidityException, IOException,
            ParsingException {
    ...
    protected String registerDigitalDocumentByApiV4(String content, String login, RegistrarCode registrarCode) throws ValidityException, IOException,
            ParsingException {
        Document doc = ApiModuleConfiguration.instanceOf().getDigDocRegistrationDataValidatingLoaderV4().loadDocument(content);
        return registerDigitalDocument(doc, login, registrarCode);
    }

    protected String registerDigitalDocument(Document doc, String login, RegistrarCode registrarCode) {
        try {
