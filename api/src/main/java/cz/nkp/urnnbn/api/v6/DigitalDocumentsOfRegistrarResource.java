...
import cz.nkp.urnnbn.api.v6.json.DigitalDocumentsBuilderJson;
...
import cz.nkp.urnnbn.xml.apiv6.builders.DigitalDocumentsBuilderXml;
import cz.nkp.urnnbn.xml.apiv6.builders.UrnNbnBuilder;
...
public class DigitalDocumentsOfRegistrarResource extends AbstractDigitalDocumentResource {

    private static final Logger LOGGER = Logger.getLogger(DigitalDocumentsOfRegistrarResource.class.getName());

    private final Registrar registrar;

    public DigitalDocumentsOfRegistrarResource(Registrar registrar) {
    ...
    private String registerDigitalDocumentReturnXml(ResponseFormat format, String content, String login, RegistrarCode registrarCode)
        ...
        Document doc = ApiModuleConfiguration.instanceOf().getDigDocRegistrationDataValidatingLoaderV6().loadDocument(content);
