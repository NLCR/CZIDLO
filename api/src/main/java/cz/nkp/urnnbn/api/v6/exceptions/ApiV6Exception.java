...
import cz.nkp.urnnbn.api.v6.json.JsonErrorBuilder;
import cz.nkp.urnnbn.xml.apiv6.builders.XmlErrorBuilder;
...
public class ApiV6Exception extends WebApplicationException {

    public ApiV6Exception(ResponseFormat format, Status status, String errorCode, String errorMessage) {
