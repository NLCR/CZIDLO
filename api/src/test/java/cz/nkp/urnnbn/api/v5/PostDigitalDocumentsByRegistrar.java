...
/**
 * Tests for POST /api/v5/registrars/${REGISTRARS_CODE}/digitalDocuments
 *
 */
public class PostDigitalDocumentsByRegistrar extends ApiV5Tests {
    ...
    public void notAuthenticated() {
        ...
        given().request().body(bodyXml).contentType(ContentType.XML)//
                .expect()//
                .statusCode(401)//
                .when().post(buildUrl(registrarCode));
    }
