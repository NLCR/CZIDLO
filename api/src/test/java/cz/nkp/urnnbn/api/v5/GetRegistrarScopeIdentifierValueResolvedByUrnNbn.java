...
/**
 * Tests for GET /api/v5/resolver/${URN_NBN}/registrarScopeIdentifiers/${ID_TYPE}
 * 
 */
public class GetRegistrarScopeIdentifierValueResolvedByUrnNbn extends ApiV5Tests {
