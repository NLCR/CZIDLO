...
/**
 * Tests for PUT /api/v5/resolver/${URN_NBN}/registrarScopeIdentifiers/${ID_TYPE_2}
 *
 */
public class PutRegistrarScopeIdentifierValueResolvedByUrnNbn extends ApiV5Tests {
