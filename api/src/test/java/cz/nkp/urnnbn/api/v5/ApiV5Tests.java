...
import cz.nkp.urnnbn.api.v5.xml.DigDocRegistrationXmlBuilder;
import cz.nkp.urnnbn.api.v5.xml.DigInstImportXmlBuilder;
import cz.nkp.urnnbn.api.pojo.*;
...
public abstract class ApiV5Tests {
    ...
    private final String NAMESPACE = "http://resolver.nkp.cz/v5/";
    private final String NAMESPACE_PREFIX = "c";
    private final String RESPONSE_XSD = "http://localhost:8080/api/v5/response.xsd";
