...
/**
 * Tests for POST /api/v5/registrars/${REGISTRAR_CODE}/digitalDocuments/registrarScopeIdentifier/${ID_TYPE}/${ID_VALUE}/digitalInstances
 *
 */
public class PostDigitalInstancesResolvedByRsId extends ApiV5Tests {
