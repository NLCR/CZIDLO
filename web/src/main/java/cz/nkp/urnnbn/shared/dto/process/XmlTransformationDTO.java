...
public class XmlTransformationDTO implements Serializable {
	...
	public String toString() {
		return "XmlTransformationDTO [id=" + id + ", name=" + name + ", description=" + description + ", ownerLogin=" + ownerLogin
				+ ", type=" + type + ", created=" + created + ", templateTemporaryFile=" + templateTemporaryFile + "]";
	}
}
