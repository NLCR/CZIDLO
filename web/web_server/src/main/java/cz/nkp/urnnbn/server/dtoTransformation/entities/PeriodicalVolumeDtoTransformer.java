...
public class PeriodicalVolumeDtoTransformer extends PublishableIntEntityDtoTransformer {

    public PeriodicalVolumeDtoTransformer(IntelectualEntity entity, List<IntEntIdentifier> enityIds, Publication publication, Originator originator,
