...
public class SourceDocumentForm extends Form {
	...
	public FormFields buildFields() {
		...
		Field volumeTitle = new TextInputValueField(new LimitedLengthValidator(200), constants.volumeTitle(), originalDto.getVolumeTitle(),
				false);
		result.addField("volumeTitle", volumeTitle);
		Field issueTitle = new TextInputValueField(new LimitedLengthValidator(50), constants.issueTitle(), originalDto.getIssueTitle(),
				false);
