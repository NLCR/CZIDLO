...
public class ProcessDTO implements Serializable {
	...
	public String toString() {
		return "ProcessDTO [id=" + id + ", ownerLogin=" + ownerLogin + ", type=" + type + ", state=" + state + ", params="
				+ Arrays.toString(params) + ", scheduled=" + scheduled + ", started=" + started + ", finished=" + finished + "]";
	}
}
