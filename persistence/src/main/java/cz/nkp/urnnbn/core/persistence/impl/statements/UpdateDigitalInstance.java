...
public class UpdateDigitalInstance implements StatementWrapper {
    ...
    public String preparedStatement() {
        return "UPDATE " + DigitalInstanceDAO.TABLE_NAME + " SET " + DigitalInstanceDAO.ATTR_ACTIVE + "=?," + DigitalInstanceDAO.ATTR_URL + "=?,"
                + DigitalInstanceDAO.ATTR_FORMAT + "=?," + DigitalInstanceDAO.ATTR_ACCESS + "=?" + " WHERE " + DigitalInstanceDAO.ATTR_ID + "=?";
    }
