...
import cz.nkp.urnnbn.xml.apiv5.unmarshallers.validation.ElementContentEnhancer;
...
public abstract class Unmarshaller {
    ...
    private static final XPathContext context = new XPathContext(NS_PREFIX_NAME, Namespaces.CZIDLO_V5_NS);
