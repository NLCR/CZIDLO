...
import cz.nkp.urnnbn.xml.apiv4.unmarshallers.validation.ElementContentEnhancer;
import cz.nkp.urnnbn.xml.apiv4.unmarshallers.validation.IsbnEnhancer;
import cz.nkp.urnnbn.xml.apiv4.unmarshallers.validation.IssnEnhancer;
import cz.nkp.urnnbn.xml.apiv4.unmarshallers.validation.LimitedLengthEnhancer;
import cz.nkp.urnnbn.xml.apiv4.unmarshallers.validation.PositiveIntValidator;
...
public abstract class IntelectualEntityUnmarshaller extends Unmarshaller {
    ...
    IntEntIdentifier identifierByElementName(Element rootEl, String elementName, IntEntIdType type, boolean mandatory, ElementContentEnhancer enhancer) {
        Elements idElements = rootEl.getChildElements(elementName, Namespaces.CZIDLO_V4_NS);
