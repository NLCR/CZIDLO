...
import cz.nkp.urnnbn.xml.apiv5.unmarshallers.validation.CcnbEnhancer;
import cz.nkp.urnnbn.xml.apiv5.unmarshallers.validation.IssnEnhancer;
 ...
 */
public class PeriodicalUnmarshaller extends IntelectualEntityUnmarshaller {

    public PeriodicalUnmarshaller(Element entityEl) {
        super(entityEl);
    }
