...
public abstract class XmlBuilder {
    ...
    protected static String CZIDLO_NS = Namespaces.CZIDLO_V5_NS;
    ...
    private static String getResponseSchema() {
        if (responseSchema == null) {
            responseSchema = Namespaces.XSI_NS + ' ' + XmlModuleConfiguration.instanceOf().getApiV5ResponseXsdLocation();
        }
