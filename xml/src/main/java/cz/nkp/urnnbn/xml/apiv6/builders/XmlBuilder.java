...
public abstract class XmlBuilder {
    ...
    protected static String CZIDLO_NS = Namespaces.CZIDLO_V6_NS;
    ...
    private static String getResponseSchema() {
        if (responseSchema == null) {
            responseSchema = Namespaces.XSI_NS + ' ' + XmlModuleConfiguration.instanceOf().getapiv6ResponseXsdLocation();
        }
