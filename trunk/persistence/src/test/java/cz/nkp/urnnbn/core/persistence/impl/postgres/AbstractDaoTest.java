...
public abstract class AbstractDaoTest extends TestCase {
	...
	public AbstractDaoTest(String testName) {
		...
		DatabaseConnector con = DatabaseConnectorFactory.getConnector(DatabaseConfig.DRIVER, DatabaseConfig.HOST, DatabaseConfig.DATABASE,
				DatabaseConfig.PORT, DatabaseConfig.LOGIN, DatabaseConfig.PASSWORD);
	...
	public RegistrarScopeIdentifier registrarScopeIdPersisted(long registrarId, long digDocId) throws DatabaseException,
			RecordNotFoundException, AlreadyPresentException {
	...
	public RegistrarScopeIdentifier registrarScopeIdPersisted(long registrarId, long digDocId, String type) throws DatabaseException,
			RecordNotFoundException, AlreadyPresentException {
		RegistrarScopeIdentifier inserted = builder.registrarScopeIdentifierWithoutIds();
		inserted.setDigDocId(digDocId);
		inserted.setRegistrarId(registrarId);
	...
	public DigitalDocument documentPersisted(long registrarId, long archiverId, long intEntId) throws DatabaseException,
