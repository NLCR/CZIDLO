...
DROP INDEX IF EXISTS REGISTRARSCOPEID_REGISTRARID_TYPE_VALUE;
...
DROP TABLE IF EXISTS URNNBNSUCCESSOR;
...
CREATE INDEX REGISTRARSCOPEID_REGISTRARID_TYPE_VALUE ON DDIDENTIFIER (REGISTRARID, TYPE, IDVALUE);
