...
import cz.nkp.urnnbn.core.persistence.impl.statements.UpdateUrnNbnSearch;
import cz.nkp.urnnbn.core.persistence.impl.transformations.UrnNbnSearchRT;
 ...
 */
public class UrnNbnSearchDaoPostgres extends AbstractDAO implements UrnNbnSearchDAO {

    private static final Logger logger = Logger.getLogger(UrnNbnSearchDaoPostgres.class.getName());

    public UrnNbnSearchDaoPostgres(DatabaseConnector connector) {
        super(connector);
    }
    ...
    public void insertUrnNbnSearch(UrnNbnSearch search) throws DatabaseException, AlreadyPresentException, RecordNotFoundException {
        ...
        try {
            ...
            if ("23505".equals(ex.getSQLState())) {
                ...
                IdPart documentCode = new IdPart(ATTR_LAST_DOCUMENT_CODE, search.getLastFoundDocumentCode());
    ...
    public UrnNbnSearch getSearchByRegistrarId(long registrarId) throws DatabaseException, RecordNotFoundException {
        ...
        DaoOperation operation = new SingleResultOperation(wrapper, new UrnNbnSearchRT());
        try {
            return (UrnNbnSearch) runInTransaction(operation);
    ...
    public void updateUrnNbnSearch(UrnNbnSearch search) throws DatabaseException, RecordNotFoundException {
        ...
        try {
            StatementWrapper updateSt = new UpdateUrnNbnSearch(search);
