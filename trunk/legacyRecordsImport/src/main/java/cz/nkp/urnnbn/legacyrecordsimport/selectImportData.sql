select r.DR_ID,r.UPDATE_TIMESTAMP as DD_updated,r.CISLO_RDCZ, r.URNNBN,
...
from 
    ...
    on r1.INSTITUCE=i.INSTITUCE_ID) r left join URNNBN.INTELEKTUALNI_ENTITA e
                                      on r.INTELEKTUALNI_ENTITA=e.IE_ID left join URNNBN.ZVEREJNENO z
                                      on r.DR_ID =z.DIGITALNI_REPREZENTACE
