...
/**
 * ISO 3166 country code that is part of urn:nbn and identifies national
 * subspace. This singleton should be initialized only once at application
 * startup TODO: should be used in all applications instead of still hardcoded
 * "CZ" or "cz"
 *
...
public class CountryCode {
    ...
    /**
     * Initializes the national code. Should be called only once at the
     * application startup.
     *
